...
public class ListaInvertida {
  ...
  // Fecha os arquivos da lista invertida.
  // (Adicionado apenas para integração: permite liberar os arquivos
  //  antes de recriá-los ou removê-los. Não altera o algoritmo.)
